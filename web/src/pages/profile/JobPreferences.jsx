...
const JobPreferences = () => {
  ...
  if (typee.Fulltime === true) {
    setJobPreferences({ type: type.concat('Full-time, ') });
  }
  if (typee.Parttime === true) {
    setJobPreferences({ type: type.concat('Part-time, ') });
  }
  if (typee.Contract === true) {
    setJobPreferences({ type: type.concat('Contract, ') });
  }
  if (typee.Temporary === true) {
    setJobPreferences({ type: type.concat('Temporary, ') });
  }
  if (typee.Internship === true) {
    setJobPreferences({ type: type.concat('Internship, ') });
  }

  if (schedulee.hr8 === true) {
    setJobPreferences({ schedule: schedule.concat('8 hour shift, ') });
  }
  if (schedulee.hr10 === true) {
    setJobPreferences({ schedule: schedule.concat('10 hour shift, ') });
  }
  if (schedulee.hr12 === true) {
    setJobPreferences({ schedule: schedule.concat('12 hour shift, ') });
  }
  if (schedulee.Dayshift === true) {
    setJobPreferences({ schedule: schedule.concat('Dayshift, ') });
  }
  if (schedulee.Nightshift === true) {
    setJobPreferences({ schedule: schedule.concat('Nightshift, ') });
  }

  if (remotee.inperson === true) {
    setJobPreferences({ remote: remote.concat('In person, ') });
  }
  if (remotee.remote === true) {
    setJobPreferences({ remote: remote.concat('Remote, ') });
  }

  if (remotee.hybrid === true) {
    setJobPreferences({ remote: remote.concat('Hybrid remote, ') });
  }
  if (remotee.temp === true) {
    setJobPreferences({ remote: remote.concat('Temporary remote, ') });
  }
                      ...
                      <FormControlLabel
                        control={(
                          <Checkbox
                            ...
                            onChange={setTypee({ Fulltime: event.target.checked })}
                            name="Full-time"
                          />
                        )}
                        label="Full-time"
                      ...
                      <FormControlLabel
                        control={(
                          <Checkbox
                            ...
                            onChange={setTypee({ Parttime: event.target.checked })}
                            name="Part-time "
                          />
                        )}
                        label="Part-time"
                      ...
                      <FormControlLabel
                        control={(
                          <Checkbox
                            ...
                            onChange={setTypee({ Contract: event.target.checked })}
                            name="Contract"
                          />
                        )}
                        label="Contract"
                      ...
                      <FormControlLabel
                        control={(
                          <Checkbox
                            ...
                            onChange={setTypee({ Temporary: event.target.checked })}
                            name="Temporary"
                          />
                        )}
                        label="Temporary"
                      ...
                      <FormControlLabel
                        control={(
                          <Checkbox
                            ...
                            onChange={setTypee({ Internship: event.target.checked })}
                            name="Internship"
                          />
                        )}
                        label="Internship"
                      ...
                      <FormControlLabel
                        control={(
                          <Checkbox
                            ...
                            onChange={setSchedulee({ hr8: event.target.checked })}
                            name="8 hour shift"
                          />
                        )}
                        label="8 hour shift"
                      ...
                      <FormControlLabel
                        control={(
                          <Checkbox
                            ...
                            onChange={setSchedulee({ hr10: event.target.checked })}
                            name="10 hour shift"
                          />
                        )}
                        label="10 hour shift"
                      ...
                      <FormControlLabel
                        control={(
                          <Checkbox
                            ...
                            onChange={setSchedulee({ hr12: event.target.checked })}
                            name="12 hour shift"
                          />
                        )}
                        label="12 hour shift"
                      ...
                      <FormControlLabel
                        control={(
                          <Checkbox
                            ...
                            onChange={setSchedulee({ Dayshift: event.target.checked })}
                            name="Day shift"
                          />
                        )}
                        label="Day shift"
                      ...
                      <FormControlLabel
                        control={(
                          <Checkbox
                            ...
                            onChange={setSchedulee({ Nightshift: event.target.checked })}
                            name="Night shift"
                          />
                        )}
                        label="Night shift"
                      ...
                      <FormControlLabel
                        control={(
                          <Checkbox
                            ...
                            onChange={setRemotee({ remote: event.target.checked })}
                            name="Remote"
                          />
                        )}
                        label="Remote"
                      ...
                      <FormControlLabel
                        control={(
                          <Checkbox
                            ...
                            onChange={setRemotee({ checked: event.target.checked })}
                            name="Hybrid remote"
                          />
                        )}
                        label="Hybrid remote"
                      ...
                      <FormControlLabel
                        control={(
                          <Checkbox
                            ...
                            onChange={setRemotee({ inperson: event.target.checked })}
                            name="In person"
                          />
                        )}
                        label="In person"
                      ...
                      <FormControlLabel
                        control={(
                          <Checkbox
                            ...
                            onChange={setRemotee({ temp: event.target.checked })}
